    ...
    <footer>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
          ...
          <div className="sm:col-span-6 md:col-span-6 lg:col-span-6">
            ...
            <ul className="text-sm">
              <li className="mb-2">
                <a href="#0" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Marketplace</a>
              </li>
              <li className="mb-2">
                <a href="#0" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Carbon SUpply Chain</a>
              </li>
              <li className="mb-2">
                <a href="#0" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Data Analytics</a>
              </li>
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          {/* Copyrights note */}
          <div className="text-sm text-gray-600 mr-4">&copy; Rocktech & EcoCiel. All rights reserved.</div>
